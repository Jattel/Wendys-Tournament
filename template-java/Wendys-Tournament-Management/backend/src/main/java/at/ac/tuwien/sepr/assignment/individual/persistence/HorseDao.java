...
public interface HorseDao {
   ...
   *
   * @param horseDetailDto the data for the new horse
   * @return the horse, that was just newly created in the persistent data store
   * @throws FatalException  if the horse could not extract key for newly created horse
   */
  Horse create(HorseDetailDto horseDetailDto) throws FatalException;
