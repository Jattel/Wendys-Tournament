...
DELETE FROM participants WHERE horse_id < 0;
...
VALUES
    (-1, 'Yearly Tournament', '2024-01-04', '2024-02-01'),
    (-2, 'Winter Tournament', '2023-12-01', '2024-12-07'),
    (-3, 'Day Tournament', '2024-01-04', '2024-01-04'),
    (-4, 'Week Tournament', '2024-01-03', '2024-07-03'),
    (-5, 'Summer Tournament', '2023-06-01', '2024-06-10');

INSERT INTO participants (horse_id, tournament_id, entryNumber, roundReached)
VALUES
    (-1, -1, 8, 0),
    (-2, -1, 1, 3),
    (-3, -1, 2, 0),
