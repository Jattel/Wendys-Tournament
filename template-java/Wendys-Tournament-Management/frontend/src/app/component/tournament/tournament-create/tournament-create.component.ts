...
import {TournamentCreateDto, TournamentDetailDto} from "../../../dto/tournament";
import {TournamentService} from "../../../service/tournament.service";
import {formatIsoDate} from "../../../util/date-helper";
import {ToastrService} from "ngx-toastr";
import {ErrorFormatterService} from "../../../service/error-formatter.service";
import {Horse, HorseSelection} from "../../../dto/horse";
...
export class TournamentCreateComponent {
  ...
  submit(form: NgForm) {
    ...
    if (form.invalid){
      let observable: Observable<TournamentCreateDto> = this.service.create(this.tournament);
    }
